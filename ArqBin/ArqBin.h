...
void* getObject(char* pathName, int indice, void (*reader)(void* obj, int seek, void* arq), void* (*allocar)()); //retorna objeto no arquivo

void* getAll(char* pathName, void (*reader)(void* obj, int seek, void* arq), void* (*allocar)()); //retorna um vetor com todos os objetos do arquivo e ultima posição nula
